...
function placeXOrO(squarenumber) {
    ...
    if (!selectedsquares.some(element => element.includes(squarenumber))) {
        ...
        if (activeplayer === 'X') {
            // if activeplaye is equal to X, the x.png is placed in the HTML
        ...
        if (activeplayer === 'X') {
            ...
            activeplayer = 'O';
            // if active player is anything the X
        } else {
...
function checkWinCondtions() {
    ...
    // this conditon checks for a tie. if none of the above conditions register and 9
...
//this function utilizes canvas to draw win lines
